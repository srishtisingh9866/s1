    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_id', models.CharField(editable=False, max_length=10, unique=True)),
                ('section', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app1.section')),
            ],
        ),
        migrations.CreateModel(
            name='Teacher',
